 ...
 * holding an org-wide role, and "is this the caller's project" is a
...
/** Creating a project (before any assignment can exist) is org-wide-role-only — see projects_insert RLS. */
 ...
 * project_assignments roster — org-wide managers, or the project's own
