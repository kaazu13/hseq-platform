...
describe("canManageSafetyFlash", () => {
  ...
  it("hse_officer can manage an organization-wide flash (no project) without any project access at all", () => {
    expect(canManageSafetyFlash(["hse_officer"], null, false)).toBe(true);
  });

  it("foreman/project_manager/inspector/employee/company_admin cannot manage, even org-wide", () => {
