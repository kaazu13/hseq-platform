...
import { HSEQ_DOCUMENT_CATEGORIES, HSEQ_DOCUMENT_CATEGORY_LABELS, SUGGESTED_DOCUMENT_LANGUAGES } from "@/modules/toolbox-templates/types";
import { TOOLBOX_DOCUMENT_STATUSES, TOOLBOX_DOCUMENT_STATUS_LABELS } from "@/modules/safety-flash/types";
import { Button } from "@/components/ui/button";
import { Input } from "@/components/ui/input";
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";

const FILTER_KEYS = ["search", "projectId", "category", "language", "status", "dateFrom", "dateTo"] as const;

export function SafetyFlashFilters({ projects }: { projects: Project[] }) {
  ...
  function setParam(key: string, value: string | null) {
    ...
    params.set("section", "safety-flash");
