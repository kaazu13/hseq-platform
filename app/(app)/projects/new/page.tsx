 ...
 * it (projects_insert RLS is org-wide-role-only for exactly this reason).
 */
export default async function NewProjectPage() {
  ...
  return (
    <div className="flex flex-1 flex-col gap-6 p-4 sm:p-6">
      <PageHeader title="New project" description="Create a new project for this organization." />
      <div className="max-w-3xl">
        <ProjectForm mode="create" organizationId={currentOrganizationId} />
      </div>
    </div>
  );
}
